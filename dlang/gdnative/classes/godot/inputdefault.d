...
public:
	...
	{
		static assert(staticIndexOf!(InputDefault, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit InputDefault");
	...
	{
		static assert(is(typeof(T.owner) : InputDefault) || staticIndexOf!(InputDefault, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend InputDefault");
