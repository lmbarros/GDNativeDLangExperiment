...
public:
	...
	{
		static assert(staticIndexOf!(VideoStream, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit VideoStream");
	...
	{
		static assert(is(typeof(T.owner) : VideoStream) || staticIndexOf!(VideoStream, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend VideoStream");
