...
public:
	...
	{
		static assert(staticIndexOf!(AudioStreamOGGVorbis, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit AudioStreamOGGVorbis");
	...
	{
		static assert(is(typeof(T.owner) : AudioStreamOGGVorbis) || staticIndexOf!(AudioStreamOGGVorbis, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend AudioStreamOGGVorbis");
	...
	void set_data(in PoolByteArray data)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("AudioStreamOGGVorbis", "set_data");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("AudioStreamOGGVorbis", "get_data");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("AudioStreamOGGVorbis", "set_loop");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("AudioStreamOGGVorbis", "has_loop");
