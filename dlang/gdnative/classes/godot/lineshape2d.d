...
public:
	...
	{
		static assert(staticIndexOf!(LineShape2D, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit LineShape2D");
	...
	{
		static assert(is(typeof(T.owner) : LineShape2D) || staticIndexOf!(LineShape2D, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend LineShape2D");
	...
	void set_normal(in Vector2 normal)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("LineShape2D", "set_normal");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("LineShape2D", "get_normal");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("LineShape2D", "set_d");
		const(void*)[1] _GODOT_args = [cast(void*)(&d), ];
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), _GODOT_args.ptr);
	}
	float get_d() const
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("LineShape2D", "get_d");
