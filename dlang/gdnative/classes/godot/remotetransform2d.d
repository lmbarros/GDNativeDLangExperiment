...
public:
	...
	{
		static assert(staticIndexOf!(RemoteTransform2D, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit RemoteTransform2D");
	...
	{
		static assert(is(typeof(T.owner) : RemoteTransform2D) || staticIndexOf!(RemoteTransform2D, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend RemoteTransform2D");
	...
	void set_remote_node(in NodePath path)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "set_remote_node");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "get_remote_node");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "set_use_global_coordinates");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "get_use_global_coordinates");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "set_update_position");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "get_update_position");
		bool _GODOT_ret = bool.init;
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), null, cast(void*)&_GODOT_ret);
		return _GODOT_ret;
	}
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "set_update_rotation");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "get_update_rotation");
		bool _GODOT_ret = bool.init;
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), null, cast(void*)&_GODOT_ret);
		return _GODOT_ret;
	}
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "set_update_scale");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("RemoteTransform2D", "get_update_scale");
		bool _GODOT_ret = bool.init;
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), null, cast(void*)&_GODOT_ret);
		return _GODOT_ret;
	}
