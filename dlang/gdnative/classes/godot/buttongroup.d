...
public:
	...
	{
		static assert(staticIndexOf!(ButtonGroup, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit ButtonGroup");
	...
	{
		static assert(is(typeof(T.owner) : ButtonGroup) || staticIndexOf!(ButtonGroup, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend ButtonGroup");
	...
	BaseButton get_pressed_button()
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("ButtonGroup", "get_pressed_button");
		BaseButton _GODOT_ret = BaseButton.init;
