...
public:
	...
	{
		static assert(staticIndexOf!(QuadMesh, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit QuadMesh");
	...
	{
		static assert(is(typeof(T.owner) : QuadMesh) || staticIndexOf!(QuadMesh, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend QuadMesh");
