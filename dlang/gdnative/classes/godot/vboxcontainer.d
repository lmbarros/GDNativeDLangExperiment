...
public:
	...
	{
		static assert(staticIndexOf!(VBoxContainer, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit VBoxContainer");
	...
	{
		static assert(is(typeof(T.owner) : VBoxContainer) || staticIndexOf!(VBoxContainer, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend VBoxContainer");
