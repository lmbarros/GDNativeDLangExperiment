...
public:
	...
	{
		static assert(staticIndexOf!(StyleBoxEmpty, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit StyleBoxEmpty");
	...
	{
		static assert(is(typeof(T.owner) : StyleBoxEmpty) || staticIndexOf!(StyleBoxEmpty, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend StyleBoxEmpty");
