...
public:
	...
	{
		static assert(staticIndexOf!(HSlider, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit HSlider");
	...
	{
		static assert(is(typeof(T.owner) : HSlider) || staticIndexOf!(HSlider, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend HSlider");
