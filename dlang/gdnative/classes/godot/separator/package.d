...
public:
	...
	{
		static assert(staticIndexOf!(Separator, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit Separator");
	...
	{
		static assert(is(typeof(T.owner) : Separator) || staticIndexOf!(Separator, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend Separator");
