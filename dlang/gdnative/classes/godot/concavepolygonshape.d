...
public:
	...
	{
		static assert(staticIndexOf!(ConcavePolygonShape, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit ConcavePolygonShape");
	...
	{
		static assert(is(typeof(T.owner) : ConcavePolygonShape) || staticIndexOf!(ConcavePolygonShape, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend ConcavePolygonShape");
	...
	void set_faces(in PoolVector3Array faces)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("ConcavePolygonShape", "set_faces");
		const(void*)[1] _GODOT_args = [cast(void*)(&faces), ];
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), _GODOT_args.ptr);
	}
	PoolVector3Array get_faces() const
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("ConcavePolygonShape", "get_faces");
