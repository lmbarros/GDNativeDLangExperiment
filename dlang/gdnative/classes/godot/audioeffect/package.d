...
public:
	...
	{
		static assert(staticIndexOf!(AudioEffect, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit AudioEffect");
	...
	{
		static assert(is(typeof(T.owner) : AudioEffect) || staticIndexOf!(AudioEffect, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend AudioEffect");
