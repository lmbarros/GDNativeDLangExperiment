...
public:
	...
	{
		static assert(staticIndexOf!(AudioEffectLowPassFilter, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit AudioEffectLowPassFilter");
	...
	{
		static assert(is(typeof(T.owner) : AudioEffectLowPassFilter) || staticIndexOf!(AudioEffectLowPassFilter, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend AudioEffectLowPassFilter");
