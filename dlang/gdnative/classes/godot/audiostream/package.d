...
public:
	...
	{
		static assert(staticIndexOf!(AudioStream, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit AudioStream");
	...
	{
		static assert(is(typeof(T.owner) : AudioStream) || staticIndexOf!(AudioStream, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend AudioStream");
