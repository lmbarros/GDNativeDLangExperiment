...
public:
	...
	{
		static assert(staticIndexOf!(CenterContainer, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit CenterContainer");
	...
	{
		static assert(is(typeof(T.owner) : CenterContainer) || staticIndexOf!(CenterContainer, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend CenterContainer");
	...
	void set_use_top_left(in bool enable)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("CenterContainer", "set_use_top_left");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("CenterContainer", "is_using_top_left");
