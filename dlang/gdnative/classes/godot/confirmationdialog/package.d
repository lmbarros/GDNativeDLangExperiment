...
public:
	...
	{
		static assert(staticIndexOf!(ConfirmationDialog, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit ConfirmationDialog");
	...
	{
		static assert(is(typeof(T.owner) : ConfirmationDialog) || staticIndexOf!(ConfirmationDialog, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend ConfirmationDialog");
	...
	Button get_cancel()
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("ConfirmationDialog", "get_cancel");
