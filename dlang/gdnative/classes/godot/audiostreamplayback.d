...
public:
	...
	{
		static assert(staticIndexOf!(AudioStreamPlayback, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit AudioStreamPlayback");
	...
	{
		static assert(is(typeof(T.owner) : AudioStreamPlayback) || staticIndexOf!(AudioStreamPlayback, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend AudioStreamPlayback");
