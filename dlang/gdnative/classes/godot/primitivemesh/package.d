...
public:
	...
	{
		static assert(staticIndexOf!(PrimitiveMesh, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit PrimitiveMesh");
	...
	{
		static assert(is(typeof(T.owner) : PrimitiveMesh) || staticIndexOf!(PrimitiveMesh, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend PrimitiveMesh");
	...
	void set_material(in Material material)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("PrimitiveMesh", "set_material");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PrimitiveMesh", "get_material");
