...
public:
	...
	{
		static assert(staticIndexOf!(VSeparator, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit VSeparator");
	...
	{
		static assert(is(typeof(T.owner) : VSeparator) || staticIndexOf!(VSeparator, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend VSeparator");
