...
public:
	...
	{
		static assert(staticIndexOf!(AudioEffectHighPassFilter, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit AudioEffectHighPassFilter");
	...
	{
		static assert(is(typeof(T.owner) : AudioEffectHighPassFilter) || staticIndexOf!(AudioEffectHighPassFilter, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend AudioEffectHighPassFilter");
