...
public:
	...
	{
		static assert(staticIndexOf!(PanelContainer, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit PanelContainer");
	...
	{
		static assert(is(typeof(T.owner) : PanelContainer) || staticIndexOf!(PanelContainer, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend PanelContainer");
