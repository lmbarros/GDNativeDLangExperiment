...
public:
	...
	{
		static assert(staticIndexOf!(ARVRCamera, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit ARVRCamera");
	...
	{
		static assert(is(typeof(T.owner) : ARVRCamera) || staticIndexOf!(ARVRCamera, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend ARVRCamera");
