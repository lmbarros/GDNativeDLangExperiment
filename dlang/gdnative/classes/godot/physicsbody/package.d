...
public:
	...
	{
		static assert(staticIndexOf!(PhysicsBody, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit PhysicsBody");
	...
	{
		static assert(is(typeof(T.owner) : PhysicsBody) || staticIndexOf!(PhysicsBody, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend PhysicsBody");
	...
	void set_collision_layer(in int layer)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "set_collision_layer");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "get_collision_layer");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "set_collision_mask");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "get_collision_mask");
		int _GODOT_ret = int.init;
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), null, cast(void*)&_GODOT_ret);
		return _GODOT_ret;
	}
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "set_collision_mask_bit");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "get_collision_mask_bit");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "set_collision_layer_bit");
		const(void*)[2] _GODOT_args = [cast(void*)(&bit), cast(void*)(&value), ];
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), _GODOT_args.ptr);
	}
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "get_collision_layer_bit");
		bool _GODOT_ret = bool.init;
		const(void*)[1] _GODOT_args = [cast(void*)(&bit), ];
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), _GODOT_args.ptr, cast(void*)&_GODOT_ret);
		return _GODOT_ret;
	...
	void add_collision_exception_with(in PhysicsBody _body)
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "add_collision_exception_with");
		const(void*)[1] _GODOT_args = [cast(void*)(_body), ];
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), _GODOT_args.ptr);
	}
	void remove_collision_exception_with(in PhysicsBody _body)
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("PhysicsBody", "remove_collision_exception_with");
		const(void*)[1] _GODOT_args = [cast(void*)(_body), ];
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), _GODOT_args.ptr);
	}
}
