...
public:
	...
	{
		static assert(staticIndexOf!(AudioEffectLowShelfFilter, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit AudioEffectLowShelfFilter");
	...
	{
		static assert(is(typeof(T.owner) : AudioEffectLowShelfFilter) || staticIndexOf!(AudioEffectLowShelfFilter, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend AudioEffectLowShelfFilter");
