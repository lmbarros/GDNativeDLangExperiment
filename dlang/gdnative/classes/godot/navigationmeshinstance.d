...
public:
	...
	{
		static assert(staticIndexOf!(NavigationMeshInstance, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit NavigationMeshInstance");
	...
	{
		static assert(is(typeof(T.owner) : NavigationMeshInstance) || staticIndexOf!(NavigationMeshInstance, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend NavigationMeshInstance");
	...
	void set_navigation_mesh(in NavigationMesh navmesh)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("NavigationMeshInstance", "set_navigation_mesh");
		const(void*)[1] _GODOT_args = [cast(void*)(navmesh), ];
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), _GODOT_args.ptr);
	}
	NavigationMesh get_navigation_mesh() const
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("NavigationMeshInstance", "get_navigation_mesh");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("NavigationMeshInstance", "set_enabled");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("NavigationMeshInstance", "is_enabled");
