...
public:
	...
	{
		static assert(staticIndexOf!(SpatialGizmo, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit SpatialGizmo");
	...
	{
		static assert(is(typeof(T.owner) : SpatialGizmo) || staticIndexOf!(SpatialGizmo, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend SpatialGizmo");
