...
public:
	...
	{
		static assert(staticIndexOf!(PhysicsServerSW, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit PhysicsServerSW");
	...
	{
		static assert(is(typeof(T.owner) : PhysicsServerSW) || staticIndexOf!(PhysicsServerSW, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend PhysicsServerSW");
