...
public:
	...
	{
		static assert(staticIndexOf!(CapsuleShape2D, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit CapsuleShape2D");
	...
	{
		static assert(is(typeof(T.owner) : CapsuleShape2D) || staticIndexOf!(CapsuleShape2D, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend CapsuleShape2D");
	...
	void set_radius(in float radius)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("CapsuleShape2D", "set_radius");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("CapsuleShape2D", "get_radius");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("CapsuleShape2D", "set_height");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("CapsuleShape2D", "get_height");
		float _GODOT_ret = float.init;
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), null, cast(void*)&_GODOT_ret);
		return _GODOT_ret;
	}
