...
public:
	...
	{
		static assert(staticIndexOf!(ToolButton, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit ToolButton");
	...
	{
		static assert(is(typeof(T.owner) : ToolButton) || staticIndexOf!(ToolButton, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend ToolButton");
