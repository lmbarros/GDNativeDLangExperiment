...
public:
	...
	{
		static assert(staticIndexOf!(LinkButton, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit LinkButton");
	...
	{
		static assert(is(typeof(T.owner) : LinkButton) || staticIndexOf!(LinkButton, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend LinkButton");
	...
	void set_text(in String text)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("LinkButton", "set_text");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("LinkButton", "get_text");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("LinkButton", "set_underline_mode");
		const(void*)[1] _GODOT_args = [cast(void*)(&underline_mode), ];
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), _GODOT_args.ptr);
	}
	int get_underline_mode() const
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("LinkButton", "get_underline_mode");
