...
public:
	...
	{
		static assert(staticIndexOf!(Position3D, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit Position3D");
	...
	{
		static assert(is(typeof(T.owner) : Position3D) || staticIndexOf!(Position3D, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend Position3D");
