...
public:
	...
	{
		static assert(staticIndexOf!(GDScript, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit GDScript");
	...
	{
		static assert(is(typeof(T.owner) : GDScript) || staticIndexOf!(GDScript, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend GDScript");
	...
	PoolByteArray get_as_byte_code() const
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("GDScript", "get_as_byte_code");
