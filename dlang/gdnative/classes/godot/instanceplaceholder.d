...
public:
	...
	{
		static assert(staticIndexOf!(InstancePlaceholder, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit InstancePlaceholder");
	...
	{
		static assert(is(typeof(T.owner) : InstancePlaceholder) || staticIndexOf!(InstancePlaceholder, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend InstancePlaceholder");
	...
	Dictionary get_stored_values(in bool with_order = false)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("InstancePlaceholder", "get_stored_values");
		Dictionary _GODOT_ret = Dictionary.empty_dictionary;
		const(void*)[1] _GODOT_args = [cast(void*)(&with_order), ];
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("InstancePlaceholder", "replace_by_instance");
		const(void*)[1] _GODOT_args = [cast(void*)(custom_scene), ];
		godot_method_bind_ptrcall(mb, cast(godot_object)(this), _GODOT_args.ptr);
	}
	String get_instance_path() const
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("InstancePlaceholder", "get_instance_path");
