...
public:
	...
	{
		static assert(staticIndexOf!(Panel, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit Panel");
	...
	{
		static assert(is(typeof(T.owner) : Panel) || staticIndexOf!(Panel, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend Panel");
