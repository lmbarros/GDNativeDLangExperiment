...
public:
	...
	{
		static assert(staticIndexOf!(MarginContainer, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit MarginContainer");
	...
	{
		static assert(is(typeof(T.owner) : MarginContainer) || staticIndexOf!(MarginContainer, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend MarginContainer");
