...
public:
	...
	{
		static assert(staticIndexOf!(ViewportContainer, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit ViewportContainer");
	...
	{
		static assert(is(typeof(T.owner) : ViewportContainer) || staticIndexOf!(ViewportContainer, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend ViewportContainer");
	...
	void set_stretch(in bool enable)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("ViewportContainer", "set_stretch");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("ViewportContainer", "is_stretch_enabled");
