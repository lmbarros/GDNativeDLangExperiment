...
public:
	...
	{
		static assert(staticIndexOf!(Shape, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit Shape");
	...
	{
		static assert(is(typeof(T.owner) : Shape) || staticIndexOf!(Shape, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend Shape");
