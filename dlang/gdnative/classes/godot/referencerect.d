...
public:
	...
	{
		static assert(staticIndexOf!(ReferenceRect, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit ReferenceRect");
	...
	{
		static assert(is(typeof(T.owner) : ReferenceRect) || staticIndexOf!(ReferenceRect, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend ReferenceRect");
