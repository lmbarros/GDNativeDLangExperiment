...
public:
	...
	{
		static assert(staticIndexOf!(SpotLight, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit SpotLight");
	...
	{
		static assert(is(typeof(T.owner) : SpotLight) || staticIndexOf!(SpotLight, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend SpotLight");
