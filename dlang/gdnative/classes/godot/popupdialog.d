...
public:
	...
	{
		static assert(staticIndexOf!(PopupDialog, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit PopupDialog");
	...
	{
		static assert(is(typeof(T.owner) : PopupDialog) || staticIndexOf!(PopupDialog, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend PopupDialog");
