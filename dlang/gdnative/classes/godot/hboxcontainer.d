...
public:
	...
	{
		static assert(staticIndexOf!(HBoxContainer, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit HBoxContainer");
	...
	{
		static assert(is(typeof(T.owner) : HBoxContainer) || staticIndexOf!(HBoxContainer, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend HBoxContainer");
