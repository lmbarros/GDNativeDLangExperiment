...
public:
	...
	{
		static assert(staticIndexOf!(InputEventScreenTouch, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit InputEventScreenTouch");
	...
	{
		static assert(is(typeof(T.owner) : InputEventScreenTouch) || staticIndexOf!(InputEventScreenTouch, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend InputEventScreenTouch");
	...
	void set_index(in int index)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("InputEventScreenTouch", "set_index");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("InputEventScreenTouch", "get_index");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("InputEventScreenTouch", "set_position");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("InputEventScreenTouch", "get_position");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("InputEventScreenTouch", "set_pressed");
