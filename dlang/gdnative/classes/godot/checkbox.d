...
public:
	...
	{
		static assert(staticIndexOf!(CheckBox, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit CheckBox");
	...
	{
		static assert(is(typeof(T.owner) : CheckBox) || staticIndexOf!(CheckBox, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend CheckBox");
