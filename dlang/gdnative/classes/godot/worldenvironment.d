...
public:
	...
	{
		static assert(staticIndexOf!(WorldEnvironment, T.BaseClasses) != -1, "Godot class "~T.stringof~" does not inherit WorldEnvironment");
	...
	{
		static assert(is(typeof(T.owner) : WorldEnvironment) || staticIndexOf!(WorldEnvironment, typeof(T.owner).BaseClasses) != -1, "D class "~T.stringof~" does not extend WorldEnvironment");
	...
	void set_environment(in Environment env)
	{
		...
		if(mb is null) mb = godot_method_bind_get_method("WorldEnvironment", "set_environment");
	...
	{
		static godot_method_bind* mb = null;
		if(mb is null) mb = godot_method_bind_get_method("WorldEnvironment", "get_environment");
